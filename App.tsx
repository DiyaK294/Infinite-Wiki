      ...
      <footer className="sticky-footer">
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.25rem' }}>
          <p className="footer-text" style={{ margin: 0 }}>
            ...
            {generationTime && !isLoading && ` · ${Math.round(generationTime)}ms`}
          </p>
          {isLoading && (
            <div className="footer-text" style={{ fontStyle: 'italic', display: 'flex', alignItems: 'center', gap: '0.5ch' }}>
              Generating content<span className="blinking-cursor">...</span>
            </div>
          )}
        </div>
      </footer>
